            ...
            {g.rows.length === 0 ? (
              <div className="bg-background rounded-lg p-3 flex items-center justify-between text-sm">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-brand border border-brand rounded-md px-3 py-1.5 disabled:opacity-50 disabled:text-muted disabled:border-border"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {g.rows.map((r) => (
                  <Link
                    ...
                    className="flex flex-col gap-0.5 bg-background rounded-lg px-3 py-2 text-sm hover:bg-brand/5"
                  >
